...
$lang = array(
    ...
    'main' => array(
        ...
        'metaDesc'      => "%s в базе данных World of Warcraft 3.3.5a от %s: характеристики, требования, где найти и комментарии сообщества.",
        'homeMetaTitle'=> "База данных World of Warcraft 3.3.5a",
        'homeMetaDesc' => "Полная база данных World of Warcraft 3.3.5a (Wrath of the Lich King): предметы, заклинания, задания, НИП, достижения, профессии, карты и калькулятор талантов, а также профайлер персонажей %s.",
        'feedback'      => "Отзыв",

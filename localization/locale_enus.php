...
$lang = array(
    ...
    'main' => array(
        ...
        'language'      => "Language",
        'mainSite'      => "Main site",
        'metaDesc'      => "%s in the World of Warcraft 3.3.5a database of %s: stats, requirements, where to find it and community comments.",
        'homeMetaTitle'=> "World of Warcraft 3.3.5a Database",
        'homeMetaDesc' => "Complete World of Warcraft 3.3.5a (Wrath of the Lich King) database: items, spells, quests, NPCs, achievements, professions, maps and a talent calculator, plus the %s character profiler.",
        'feedback'      => "Feedback",

...
$lang = array(
    ...
    'main' => array(
        ...
        'metaDesc'      => "%s dans la base de données World of Warcraft 3.3.5a de %s : statistiques, prérequis, où le trouver et commentaires de la communauté.",
        'homeMetaTitle'=> "Base de données World of Warcraft 3.3.5a",
        'homeMetaDesc' => "Base de données complète de World of Warcraft 3.3.5a (Wrath of the Lich King) : objets, sorts, quêtes, PNJ, hauts faits, métiers, cartes et calculateur de talents, ainsi que le profileur de personnages de %s.",
        'feedback'      => "Feedback",

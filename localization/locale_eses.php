...
$lang = array(
    ...
    'main' => array(
        ...
        'language'      => "Idioma",
        'mainSite'      => "Web principal",
        'metaDesc'      => "%s en la base de datos de World of Warcraft 3.3.5a de %s: estadísticas, requisitos, dónde encontrarlo y comentarios de la comunidad.",
        'homeMetaTitle'=> "Base de datos de World of Warcraft 3.3.5a",
        'homeMetaDesc' => "Base de datos completa de World of Warcraft 3.3.5a (Wrath of the Lich King): objetos, hechizos, misiones, PNJ, logros, profesiones, mapas y calculadora de talentos, además del perfilador de personajes de %s.",

...
$lang = array(
    ...
    'main' => array(
        ...
        'language'      => "Sprache",
        'mainSite'      => "Hauptseite",
        'metaDesc'      => "%s in der World-of-Warcraft-3.3.5a-Datenbank von %s: Werte, Voraussetzungen, Fundorte und Kommentare der Community.",
        'homeMetaTitle'=> "World-of-Warcraft-3.3.5a-Datenbank",
        'homeMetaDesc' => "Vollständige World-of-Warcraft-3.3.5a-Datenbank (Wrath of the Lich King): Gegenstände, Zauber, Quests, NPCs, Erfolge, Berufe, Karten und Talentrechner sowie der Charakterprofiler von %s.",

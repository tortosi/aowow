...
$lang = array(
    ...
    'main' => array(
        ...
        'language'      => "语言",
        'mainSite'      => "主站",
        'metaDesc'      => "%s，来自 %s 的魔兽世界 3.3.5a 数据库：属性、需求、获取途径与社区评论。",
        'homeMetaTitle'=> "魔兽世界 3.3.5a 数据库",
        'homeMetaDesc' => "完整的魔兽世界 3.3.5a（巫妖王之怒）数据库：物品、法术、任务、NPC、成就、专业、地图与天赋计算器，以及 %s 的角色档案查询。",
        'feedback'      => "反馈",
        'numSQL'        => "数据库查询次数",
        'timeSQL'       => "数据库查询时间",
